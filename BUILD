...
cc_binary(
    name = "orca_fifo_agent",
    srcs = [
        "schedulers/orca_fifo/orca_agent.cc",
    ],
    copts = compiler_flags,
    deps = [
        ":agent",
...
cc_library(
    name = "orca_fifo_scheduler",
    srcs = [
        "schedulers/orca_fifo/per_cpu/fifo_scheduler.cc",
        "schedulers/orca_fifo/per_cpu/fifo_scheduler.h",
